...
\author{\textbf{Alex}}
\affiliation{%
  \institution{Georgia Tech Shenzhen Institute}
...
\email{qinrui@gatech.edu}

\author{\textbf{Tianshu}}
\affiliation{%
  \institution{Georgia Tech Shenzhen Institute}
  \streetaddress{North Avenue}
  \city{Shenzhen} 
