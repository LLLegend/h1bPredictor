...
We integrated all data, the prediction model, and visualizations within a single 
...
(Including visualizations by year, state, and occupation. ASDFASDFASDFASDFASDFASDFASDFASDFASDFASDF)

We found the choropleth to make the most sense for breaking data up by state, 
