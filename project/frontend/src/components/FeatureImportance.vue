...
export default {
  ...
  methods: {
    ...
    updateUI(FeatureImportanceData) {
      ...
      let data = [];
      for (let [key, value] of Object.entries(FeatureImportanceData[0])) {
      ...
      var y = d3.scaleBand().range([height, 0]).domain(data.map(function(d) { return d.feature; })).padding(0.1);
      svg.append("g")
          //         .attr("class", "x axis")
